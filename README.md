# Student Grading & GPA Evaluation System

Academic grading system designed for instructors to log coursework marks, calculate GPAs, assign letter grades, and generate student report cards.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/XREFS0/masa-student-grading-sqlite.git
   cd masa-student-grading-sqlite
   ```
